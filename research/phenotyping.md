...
<section class="rd-band rd-band--dark">
  <div class="rd-band__inner">
    ...
    <div class="rd-topics-grid rd-topics-grid--pipeline">
      ...
      <div class="rd-topics-grid__card">
        <img src="{{ '/assets/img/research/scan-model.png' | relative_url }}" alt="3D plant canopy model in Blender">
      ...
      <div class="rd-topics-grid__card">
        <img src="{{ '/assets/img/research/scan-view-2.png' | relative_url }}" alt="Ray-tracing simulation in ANSYS">
